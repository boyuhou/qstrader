...
class IqfeedCsvBarPriceHandler(AbstractBarPriceHandler):
    def __init__(self, csv_dir, events_queue, ticker, period, start_date, end_date):
    ...
    def subscribe_ticker(self, ticker):
        try:
            ...
            print(str.format('Could not subscribe ticker {0} as no data CSV found for pricing', ticker))
    ...
    def _open_ticker_price_csv(self, ticker):
        ...
        self.ticker_data = price_df
        return price_df

    def _merge_sort_ticker_data(self):
        return self.ticker_data.sort_index().iterrows()
